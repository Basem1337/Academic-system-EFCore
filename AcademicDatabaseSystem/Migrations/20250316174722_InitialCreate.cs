        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Ismailia Branch Building, 2nd Floor", "MAD", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Basem", "Mohamed", "01016297668" },
                    { 2, "Amr", "Hany", "01542197951" },
                    { 3, "Alaa", "Eisa", "01111190922" },
                    { 4, "Hany", "Abdou", "01004190041" },
                    { 5, "Omar", "Al-Araby", "01204144070" },
                    { 6, "Mohamed", "Hisham", "01100488122" },
                    { 7, "Mahmoud", "Ahmed", "01010556101" },
                    { 8, "Karim", "Helmy", "01550507768" },
                    { 9, "Basem", "Atia", "01100557030" },
                    { 10, "Mohamed", "Abdelwahab", "01004117122" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Mohamed", "Tharwat", "01016297668", 5000m },
                    { 2, 1, "Mohamed", "Hatem", "01004190041", 7500m },
                    { 3, 2, "Mai", "Moustafa", "01550507768", 4800m },
                    { 4, 1, "Rami", "Mohamed", "01010556101", 6000m },
                    { 5, 2, "Hala", "Nazmy", "01004117122", 8000m },
                    { 6, 3, "Asmaa", "Gomaa", "01100488122", 8000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 3, new DateTime(2024, 1, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "Intro to C#" },
                    { 4, 4, new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "Intro to OOP" },
                    { 5, 5, new DateTime(2021, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, "Intro to SQL" },
                    { 6, 10, new DateTime(2025, 10, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, "Intro to Angular" }
                });
